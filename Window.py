...
GREEN_COLOR_RGB, BLUE_COLOR_RGB, WIDTH,NUM_ROWS, CELL_SIZE,TERMINAL_CELLS, ROSE_COLOR_RGB, GREEN_COLOR_RGB, MARSALA_COLOR_RGB, SAND_COLOR_RGB, PEPPER_COLOR_RGB)
...
class Window(object):
    ...
    def updateSurface(self, player):
        self.drawPlayer(player)
        pygame.display.update()
    def fillSurfaceWithColor(self, color=ROSE_COLOR_RGB):
        self.surface.fill(color)

    def drawGridLines(self, numRows=NUM_ROWS, lineColor=BLACK_COLOR_RGB):
        xPos = 0
        yPos = 0
    ...
    def drawPlayer(self, player):
        ...
        pygame.draw.circle(self.surface, MARSALA_COLOR_RGB,centerPoint, radius)
    ...
    def drawRewardAndPenaltySquares(self, board):
        ...
        cellGoals = TERMINAL_CELLS[0]

        # Color the cells
        for c in cellsWithPenalties.keys(): self.colorCell(color=PEPPER_COLOR_RGB, cell=c)
        #for c in cellsWithRewards.keys(): self.colorCell(color=GREEN_COLOR_RGB, cell=c)
        self.colorCell(color=GREEN_COLOR_RGB, cell=cellGoals)
